...
def collect_responses(prompt):
    ...
    # Print the user's prompt and AI's response
    #print('User:', prompt)
...
user_message_1 = f"""
tell me the first steps to setting up a TAP ModiDAR. """
...
def internal_model():
    # collect display 
    user_input = input("How can i be of service? ")
    if user_input == "Thanks that's fine":
        return
    context =  [  
...
if user_model == 'i':
    ...
    print("Invalid input. Please choose 'i' for internal mode or 'e' for external mode.")
